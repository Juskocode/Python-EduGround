...
globalThis.window = {};
await import(pathToFileURL(path.join(PUBLIC_ROOT, "content/learning-content.js")));
await import(pathToFileURL(path.join(PUBLIC_ROOT, "content/assessment-data.js")));
