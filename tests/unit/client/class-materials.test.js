...
for (const filename of [
  "public/content/exercise-data.js",
  "curriculum/generated/solution-code.js",
  "public/content/class-materials.js",
]) {
...
test("every chapter reads as a complete 50 to 90 minute classroom syllabus", () => {
  ...
  assert.equal(declaredMinutes, 1170, "thirteen 90-minute classes should provide 1,170 planned minutes");
});
