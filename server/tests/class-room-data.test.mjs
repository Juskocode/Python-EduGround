...
const classMaterialsSource = await readFile(
  resolve(REPOSITORY_ROOT, "class-materials.js"),
  "utf8",
);
const solutionShapeSource = await readFile(
  resolve(REPOSITORY_ROOT, "solution-shape.js"),
  "utf8",
);
const courseAppSource = await readFile(
  resolve(REPOSITORY_ROOT, "course-app.js"),
  "utf8",
);
const pythonWorkerSource = await readFile(
  resolve(REPOSITORY_ROOT, "python-runner-worker.mjs"),
  "utf8",
);
